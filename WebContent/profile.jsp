	...
	<div class="row" id="main">
        <div class="col-md-4 well" id="leftPanel">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6"><a href="profileEdit.jsp" class="btn btn-primary">Edit your profile</a></div>
        			</div>
        		</div>
            </div>
        </div>
    ...
    <div class="col-md-12">
      ...
      <h2>Your profile details:</h2>
        <table class="UserTable">
          <tr>
            <td><h2><small>Name:</small><h2></td>
            <td> this is my name </td>
          </tr>
          <tr>
            <td><h2><small>Email:</small><h2></td>
            <td> this is my email </td>
          </tr>
          <tr>
            <td><h2><small>Description:</small><h2></td>
